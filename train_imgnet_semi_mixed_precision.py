...
def train_student(args, student_model, student_normalize, clip_model, clip_normalize,
    ...
    scheduler = torch.optim.lr_scheduler.ChainedScheduler([
        ...
        torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.train_epoch * len(train_loader_unlabeled) // accumulation_steps - 5000)
    ])
    ...
    for epoch in range(args.train_epoch):
        ...
        for batch_idx, (unlabeled_imgs_student, unlabeled_imgs_clip, _) in enumerate(pbar):
            try:
            ...
            # Get student predictions with mixed precision
            ...
            progress_dict = {
                ...
                'Dist_L': f'{distill_loss_labeled.item() * accumulation_steps:.4f}',
                'Dist_U': f'{distill_loss_unlabeled.item() * accumulation_steps:.4f}',
                'step': f'{(batch_idx + 1) % accumulation_steps}/{accumulation_steps}'
            }
